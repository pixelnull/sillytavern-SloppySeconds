...
export const SETTINGS_VERSION = 3; // Bump when adding new default slopPatterns
...
export const defaultSettings = {
    ...
    slopPatterns: [
        ...
        // Eyes & gaze (community #1 complaint)
        'eyes that held',
        ...
        'fidgeting with the hem',
        'picking at the hem',
        'tucked a strand of hair behind',
        'knowing smile',
        'playful smirk',
        'bit her lower lip',
        // Emotional telling
